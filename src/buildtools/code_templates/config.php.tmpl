...
// +---------------------------------------------------------------------------+
// AgaviConfig::set('core.app_dir', '%%PATH_TO_AGAVI%%');
...
// |  - core.modules_dir   (defaults to "<core.webapp_dir>/modules")           |
// |  - core.templates_dir (defaults to "<core.webapp_dir>/templates")         |
// +---------------------------------------------------------------------------+
