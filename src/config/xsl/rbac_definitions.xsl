...
<xsl:stylesheet
	...
	xmlns:rbac_definitions_1_0="http://agavi.org/agavi/config/parts/rbac_definitions/1.0"
	xmlns:rbac_definitions_1_1="http://agavi.org/agavi/config/parts/rbac_definitions/1.1"
>
	...
	<xsl:variable name="rbac_definitions_1_1" select="'http://agavi.org/agavi/config/parts/rbac_definitions/1.1'" />
