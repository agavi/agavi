...
<xsl:stylesheet
	...
	xmlns:output_types_1_0="http://agavi.org/agavi/config/parts/output_types/1.0"
	xmlns:output_types_1_1="http://agavi.org/agavi/config/parts/output_types/1.1"
>
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="output_types_1_0" select="'http://agavi.org/agavi/config/parts/output_types/1.0'" />
	<xsl:variable name="output_types_1_1" select="'http://agavi.org/agavi/config/parts/output_types/1.1'" />
