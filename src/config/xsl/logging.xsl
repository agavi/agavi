...
<xsl:stylesheet
	...
	xmlns:logging_1_0="http://agavi.org/agavi/config/parts/logging/1.0"
	xmlns:logging_1_1="http://agavi.org/agavi/config/parts/logging/1.1"
>
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="logging_1_0" select="'http://agavi.org/agavi/config/parts/logging/1.0'" />
	<xsl:variable name="logging_1_1" select="'http://agavi.org/agavi/config/parts/logging/1.1'" />
