...
/**
 * Data file for %s timezone, compiled from the olson data.
 *
...
?>';
		...
		foreach($zones as $name => $zone) {
			...
			file_put_contents($pathname, sprintf($baseCode, $name, var_export($zone, true)));
		}
		...
		file_put_contents($this->outputDir . '/zonelist.php', sprintf($baseCode, var_export($zoneList, true)));
	}
}
