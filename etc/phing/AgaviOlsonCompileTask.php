 ...
 * %s
 *
 * Auto-generated by the phing olson task on ' . gmdate('m/d/Y H:i:s'). '
 *
 * @package    agavi
...
?>';
		...
		foreach($zones as $name => $zone) {
			...
			file_put_contents($pathname, sprintf($baseCode, 'Data file for ' . $name . ' timezone, compiled from the olson data.', var_export($zone, true)));
		}
		...
		file_put_contents($this->outputDir . '/zonelist.php', sprintf($baseCode, 'Zone list file', var_export($zoneList, true)));
	}
}
