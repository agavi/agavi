...
<?php endif; ?>
	...
	<li><a href="<?php echo $ro->gen('search_engine_spam', array('name' => $template['product']['name'], 'id' => $template['product']['id'])); ?>"><?php echo $tm->_('Search Engine Spam', 'default.menu'); ?></a></li>
</ul>
