...
<?php endif; ?>
	<li><a href="<?php echo $ro->gen('secret1'); ?>"><?php echo $tm->_('A Secure Action', 'default.menu'); ?></a></li>
	<li><a href="<?php echo $ro->gen('secret2'); ?>"><?php echo $tm->_('Another Secure Action', 'default.menu'); ?></a></li>
