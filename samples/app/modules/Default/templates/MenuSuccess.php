...
<?php endif; ?>
	...
	<li><a href="<?php echo $ro->gen('search_engine_spam', array('name' => $template['product']->getName(), 'id' => $template['product']->getId())); ?>"><?php echo $tm->_('Search Engine Spam', 'default.menu'); ?></a></li>
</ul>
