<?php return array(
	array(
		...
		'baseHref' => 'http://impl.user.compass.cynigram.com/tests/apache2.2-rewrite/',
		'_ENV' => array (
		),
		'_GET' => array (
		),
		'_SERVER' => array (
			...
			'HTTP_HOST' => 'impl.user.compass.cynigram.com',
			'PATH' => '/sbin:/bin:/usr/sbin:/usr/bin',
			'SERVER_SIGNATURE' => 'Apache/2.2.4 (FreeBSD) mod_ssl/2.2.4 OpenSSL/0.9.7e-p1 DAV/2 proxy_html/2.5 PHP/5.2.2 with Suhosin-Patch mod_ruby/1.2.6 Ruby/1.8.6(2007-03-13) mod_python/3.3.1 Python/2.4.4 mod_perl/2.0.3 Perl/v5.8.8 Server at impl.user.compass.cynigram.com Port 80
		',
			...
			'SERVER_NAME' => 'impl.user.compass.cynigram.com',
			'SERVER_ADDR' => '66.57.33.148',
			'SERVER_PORT' => '80',
			'REMOTE_ADDR' => '80.135.2.151',
			'DOCUMENT_ROOT' => 'www/apache22/data',
			'SERVER_ADMIN' => 'webmaster@compass.cynigram.com',
	...
	array(
		...
		'_SERVER' => array (
			'UNIQUE_ID' => 'TjIGGUI5IZQAAAmWWrQAAAAF',
			'HTTP_ACCEPT' => '*/*',
			'HTTP_ACCEPT_LANGUAGE' => 'de-de',
			'HTTP_ACCEPT_ENCODING' => 'gzip, deflate',
			'HTTP_USER_AGENT' => 'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/419 (KHTML, like Gecko) Safari/419.3',
		...
		',
			...
			'REQUEST_METHOD' => 'GET',
			'QUERY_STRING' => 'foo=ba//r',
			'REQUEST_URI' => '/tests/apache2.2-rewrite/index.php/fubar?foo=ba//r',
			'SCRIPT_NAME' => '/tests/apache2.2-rewrite/index.php',
			'PATH_INFO' => '/fubar',
			'PATH_TRANSLATED' => '/home/impl/public_html/fubar',
			'PHP_SELF' => '/tests/apache2.2-rewrite/index.php/fubar',
			'REQUEST_TIME' => 1180911159,
		)
	),
	array(
	...
	array(
		...
		'_SERVER' => array (
			'UNIQUE_ID' => 'UdV7zEI5IZQAAAmXXGkAAAAG',
			'HTTP_ACCEPT' => '*/*',
			'HTTP_ACCEPT_LANGUAGE' => 'de-de',
			'HTTP_ACCEPT_ENCODING' => 'gzip, deflate',
			'HTTP_USER_AGENT' => 'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/419 (KHTML, like Gecko) Safari/419.3',
			'HTTP_IF_MODIFIED_SINCE' => 'Sun, 03 Jun 2007 22:49:47 GMT',
			'HTTP_CONNECTION' => 'keep-alive',
			'HTTP_HOST' => 'impl.user.compass.cynigram.com',
			'PATH' => '/sbin:/bin:/usr/sbin:/usr/bin',
			'SERVER_SIGNATURE' => 'Apache/2.2.4 (FreeBSD) mod_ssl/2.2.4 OpenSSL/0.9.7e-p1 DAV/2 proxy_html/2.5 PHP/5.2.2 with Suhosin-Patch mod_ruby/1.2.6 Ruby/1.8.6(2007-03-13) mod_python/3.3.1 Python/2.4.4 mod_perl/2.0.3 Perl/v5.8.8 Server at impl.user.compass.cynigram.com Port 80
		',
			...
			'PATH_TRANSLATED' => '/home/impl/public_html/fu/bar',
			'PHP_SELF' => '/tests/apache2.2-rewrite/index.php/fu//bar',
			'REQUEST_TIME' => 1180911220,
		)
	),
	array(
		'message' => 'Sub-directory, rewritten, called path with three slashes with query',
		'input' => '/fu///bar',
		'prefix' => '/tests/apache2.2-rewrite',
		'basePath' => '/tests/apache2.2-rewrite/',
		'baseHref' => 'http://impl.user.compass.cynigram.com/tests/apache2.2-rewrite/',
