...
final class AgaviPhingEventDispatcherManager
{
	...
	/**
	 * Registers a new dispatcher manager.
	 *
	 * @param      Project The project for which the dispatcher will be
	 *                     registered.
	 *
	 * @return     AgaviPhingEventDispatcher The dispatcher.
	 */
	public static function register(Project $project)
	{
	...
	public static function get(Project $project)
	{
		...
		return isset(self::$dispatchers[$hash]) ? self::$dispatchers[$hash] : null;
	}
